...
#define CP_NATIVE_SYSTEM_STATUS 1u
#define CP_NATIVE_SYSTEM_STATUS_LEGACY_COUNT 5u
#define CP_NATIVE_SYSTEM_STATUS_COUNT 6u
...
enum cp_ui_font {
    ...
    CP_UI_FONT_NUMBER,
    CP_UI_FONT_DISPLAY,
    CP_UI_FONT_CONDENSED_16,
    CP_UI_FONT_CONDENSED_22,
    CP_UI_FONT_CONDENSED_32,
    CP_UI_FONT_SERIF_14,
    CP_UI_FONT_SERIF_28,
