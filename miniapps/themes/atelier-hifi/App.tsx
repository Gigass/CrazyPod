...
const styles = StyleSheet.create({
  ...
  topRail: { position: "absolute", left: 20, top: 4, width: 280, height: 20,
    backgroundColor: "#16110d", borderColor: "#6f5132", borderWidth: 1,
    borderRadius: 4, opacity: 0.94 },
  topTime: { position: "absolute", left: 29, top: 7, width: 52, height: 15,
    color: "#d9a15d", fontSize: 12 },
  topState: { position: "absolute", left: 112, top: 7, width: 96, height: 15,
    color: "#ffe1ac", fontSize: 12, textAlign: "center" },
  topBattery: { position: "absolute", left: 229, top: 7, width: 62, height: 15,
    color: "#d4c2aa", fontSize: 12, textAlign: "right" },
  ...
  kicker: { position: "absolute", left: 10, top: 4, width: 78, height: 15,
    color: "#d9a15d", fontFamily: "system", fontSize: 12 },
  title: { position: "absolute", left: 10, top: 23, width: 127, height: 20,
    color: "#f6ecd8", fontFamily: "serif", fontSize: 16, fontWeight: "700" },
  artist: { position: "absolute", left: 10, top: 45, width: 127, height: 19,
    color: "#d0b99d", fontSize: 15 },
  album: { position: "absolute", left: 10, top: 65, width: 127, height: 15,
    color: "#8f8376", fontSize: 12 },
  favorite: { position: "absolute", left: 10, top: 82, width: 88, height: 15,
    color: "#ff8fa2", fontSize: 12 },
  modeText: { position: "absolute", left: 102, top: 82, width: 35, height: 15,
    color: "#55d6e7", fontSize: 12 },
  statusPlate: { position: "absolute", left: 88, top: 4, width: 40, height: 16,
    backgroundColor: "#7b441d", borderColor: "#d59b59", borderWidth: 1,
    borderRadius: 3 },
  statusText: { width: 38, height: 15, color: "#ffe1ac", fontSize: 12,
    textAlign: "center" },
  volume: { position: "absolute", left: 65, top: 98, width: 67, height: 15,
    color: "#b8a38c", fontSize: 12, textAlign: "right" },
  lyricsOverlay: { backgroundColor: "#050403", opacity: 1 },
  lyricsHeader: { width: 260, height: 15, color: "#d9a15d", fontSize: 12,
    fontFamily: "mono", textAlign: "center", marginBottom: 4 },
  lyricsCloseHint: { width: 260, height: 15, color: "#bca384", fontSize: 12,
    textAlign: "center", marginTop: 2 },
  transportDeck: { position: "absolute", left: 27, top: 168, width: 266, height: 59,
  ...
  previousHint: { position: "absolute", left: 14, top: 31, width: 50, height: 19,
    color: "#8d7962", fontSize: 15 },
  centerHint: { position: "absolute", left: 70, top: 31, width: 126, height: 19,
    color: "#bca384", fontSize: 15, textAlign: "center" },
  nextHint: { position: "absolute", left: 201, top: 31, width: 49, height: 19,
    color: "#8d7962", fontSize: 15, textAlign: "right" },
  ...
  panel: { position: "absolute", left: 35, top: 16, width: 250, height: 208,
    backgroundColor: "#15120f", borderColor: "#d89142", borderWidth: 1,
    borderRadius: 10, padding: 12 },
  panelSmall: { position: "absolute", left: 35, top: 36, width: 250, height: 168,
    backgroundColor: "#15120f", borderColor: "#d89142", borderWidth: 1,
    borderRadius: 10, padding: 12 },
  lyricsPanel: { position: "absolute", left: 16, top: 36, width: 288, height: 190,
    backgroundColor: "#15120f", borderColor: "#d89142", borderWidth: 1,
    borderRadius: 10, padding: 12 },
  lyricsRows: { width: 260, height: 116 },
  panelTitle: { width: 226, height: 20, color: "#d9a15d", fontFamily: "system", fontSize: 16,
    textAlign: "center", marginBottom: 5 },
  menuOn: { width: 226, height: 27, backgroundColor: "#d89142",
    borderRadius: 4, marginBottom: 2, justifyContent: "center" },
  menuOff: { width: 226, height: 27, backgroundColor: "#231c16",
    borderRadius: 4, marginBottom: 2, justifyContent: "center" },
  menuTextOn: { width: 226, height: 20, color: "#130f0b", fontSize: 16,
    textAlign: "center" },
  menuTextOff: { width: 226, height: 20, color: "#d8c6aa", fontSize: 16,
    textAlign: "center" },
  queueRow: { width: 226, height: 43, backgroundColor: "#211b16",
    borderColor: "#3e3025", borderWidth: 1, borderRadius: 5, marginBottom: 3 },
  queueRowOn: { width: 226, height: 43, backgroundColor: "#6f4828",
    borderColor: "#d89142", borderWidth: 1, borderRadius: 5, marginBottom: 3 },
  queueTitle: { width: 212, height: 19, color: "#cdbda4", fontSize: 15,
    marginLeft: 7, marginTop: 3 },
  queueArtist: { width: 212, height: 15, color: "#a99a87", fontSize: 12,
    marginLeft: 7, marginTop: 1 },
  queueTitleOn: { width: 212, height: 19, color: "#fff1d4", fontSize: 15,
    marginLeft: 7, marginTop: 3 },
  queueArtistOn: { width: 212, height: 15, color: "#f0c894", fontSize: 12,
    marginLeft: 7, marginTop: 1 },
  panelHint: { width: 226, height: 15, color: "#a99a87", fontSize: 12,
    textAlign: "center", marginTop: 4 },
  lyricDim: { color: "#867665", fontSize: 15, lineHeight: 20,
    textAlign: "center" },
  lyricCurrent: { color: "#fff0d0", fontSize: 18, lineHeight: 24,
  ...
  seekValue: { width: 226, height: 20, color: "#f4dfbc", fontSize: 16,
