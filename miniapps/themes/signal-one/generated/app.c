...
static int cp_render(void)
{
    ...
    UI_OK(ui->set_i32(h4, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    UI_OK(ui->set_i32(h5, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    UI_OK(ui->set_i32(h9, CP_UI_PROP_FONT, CP_UI_FONT_CJK));
    ...
    UI_OK(ui->set_i32(h10, CP_UI_PROP_FONT, CP_UI_FONT_BODY));
    ...
    UI_OK(ui->set_i32(h13, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    UI_OK(ui->set_i32(h16, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    if(state_panel == 1) {
        ...
        UI_OK(ui->set_i32(h32, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 0) {
            ...
            UI_OK(ui->set_i32(h35, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 1) {
            ...
            UI_OK(ui->set_i32(h37, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 2) {
            ...
            UI_OK(ui->set_i32(h39, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 3) {
            ...
            UI_OK(ui->set_i32(h41, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 4) {
            ...
            UI_OK(ui->set_i32(h43, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_action == 5) {
            ...
            UI_OK(ui->set_i32(h45, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    if(state_panel == 2) {
        ...
        UI_OK(ui->set_i32(h49, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        text_cursor = 0;
        text_buffer[0] = '\0';
        cp_text_append(text_buffer, sizeof(text_buffer), &text_cursor, "QUEUE /");
        cp_i32_append(text_buffer, sizeof(text_buffer), &text_cursor, ((state_queueInfo[1] > 0) ? (state_queueSelected + 1) : 0));
    ...
    if(state_panel == 3) {
        ...
        if(state_mode == 0) {
            ...
            UI_OK(ui->set_i32(h67, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_mode == 1) {
            ...
            UI_OK(ui->set_i32(h69, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_mode == 2) {
            ...
            UI_OK(ui->set_i32(h71, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        if(state_mode == 3) {
            ...
            UI_OK(ui->set_i32(h73, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        UI_OK(ui->set_i32(h74, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    if(state_panel == 4) {
        ...
        UI_OK(ui->set_i32(h78, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        UI_OK(ui->set_i32(h81, CP_UI_PROP_FONT, CP_UI_FONT_BODY));
        ...
        UI_OK(ui->set_i32(h82, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        UI_OK(ui->set_i32(h83, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
    ...
    if(state_panel == 5) {
        ...
        UI_OK(ui->set_i32(h89, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
        ...
        UI_OK(ui->set_i32(h92, CP_UI_PROP_FONT, CP_UI_FONT_BODY));
        ...
        UI_OK(ui->set_i32(h93, CP_UI_PROP_FONT, CP_UI_FONT_CAPTION));
