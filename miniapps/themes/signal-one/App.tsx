...
const styles = StyleSheet.create({
  ...
  topRail: { position: "absolute", left: 18, top: 6, width: 284, height: 16,
    backgroundColor: "#d4d0c8", borderColor: "#878780", borderWidth: 1,
    borderRadius: 3, opacity: 0.96 },
  topTime: { position: "absolute", left: 27, top: 8, width: 52, height: 13,
    color: "#555651", fontSize: 11 },
  topState: { position: "absolute", left: 112, top: 8, width: 96, height: 13,
    color: "#d94d0b", fontSize: 11, textAlign: "center" },
  topBattery: { position: "absolute", left: 239, top: 10, width: 54, height: 8,
    color: "#555651", fontSize: 11, textAlign: "right" },
  ...
  coverLabel: { position: "absolute", left: 27, top: 136, width: 88, height: 9,
    color: "#a9aaa7", fontSize: 11, textAlign: "center" },
  brand: { position: "absolute", left: 136, top: 31, width: 104, height: 10,
    color: "#555651", fontFamily: "mono", fontSize: 11 },
  ...
  title: { position: "absolute", left: 0, top: 14, width: 148, height: 17,
    color: "#f2f0e9", fontFamily: "mono", fontSize: 14, fontWeight: "700" },
  artist: { position: "absolute", left: 0, top: 36, width: 148, height: 14,
    color: "#d0d1cc", fontSize: 11 },
  album: { position: "absolute", left: 0, top: 54, width: 148, height: 13,
    color: "#b8bbb4", fontSize: 11 },
  ...
  statusText: { position: "absolute", left: 0, top: 78, width: 34, height: 9,
    color: "#f36b21", fontSize: 11 },
  modeText: { position: "absolute", left: 39, top: 78, width: 34, height: 9,
    color: "#bfc1bc", fontSize: 11 },
  favorite: { position: "absolute", left: 68, top: 76, width: 53, height: 13,
    color: "#f2f0e9", fontSize: 11, textAlign: "right" },
  volume: { position: "absolute", left: 125, top: 78, width: 23, height: 11,
    color: "#bfc1bc", fontSize: 11, textAlign: "right" },
  ...
  lyricsRows: { width: 262, height: 96 },
  lyricsHeader: { width: 262, height: 14, color: "#555651", fontSize: 11,
    fontFamily: "mono", fontWeight: "700", textAlign: "center", marginBottom: 4 },
  lyricsCloseHint: { width: 262, height: 13, color: "#555651", fontSize: 11,
    textAlign: "center" },
  ...
  progressLabel: { position: "absolute", left: 61, top: 198, width: 70, height: 11,
    color: "#6d6e69", fontSize: 11 },
  progressValue: { position: "absolute", left: 183, top: 198, width: 106, height: 11,
    color: "#6d6e69", fontSize: 11, textAlign: "right" },
  transportHint: { position: "absolute", left: 34, top: 222, width: 252, height: 8,
    color: "#6d6e69", fontSize: 11, textAlign: "center" },
  ...
  panelTitle: { position: "absolute", left: 47, top: 34, width: 222, height: 11,
    color: "#555651", fontFamily: "mono", fontSize: 11, fontWeight: "700" },
  ...
  menuOff: { width: 222, height: 19, backgroundColor: "#3a3b39",
    ...
    marginBottom: 2, justifyContent: "center" },
  menuTextOn: { width: 206, height: 11, color: "#171816", fontSize: 11,
    marginLeft: 8 },
  menuTextOff: { width: 206, height: 11, color: "#d6d6d0", fontSize: 11,
    marginLeft: 8 },
  ...
  queueTitle: { width: 208, height: 13, color: "#e3e2dc", fontSize: 11,
    marginLeft: 7, marginTop: 3 },
  queueArtist: { width: 208, height: 11, color: "#9a9c97", fontSize: 11,
    marginLeft: 7, marginTop: 1 },
  queueTitleOn: { width: 208, height: 13, color: "#171816", fontSize: 11,
    marginLeft: 7, marginTop: 3 },
  queueArtistOn: { width: 208, height: 11, color: "#592512", fontSize: 11,
    marginLeft: 7, marginTop: 1 },
  ...
  panelHint: { position: "absolute", left: 49, top: 178, width: 222, height: 9,
    color: "#9ea09a", fontSize: 11, textAlign: "center" },
  lyricsList: { position: "absolute", left: 49, top: 67, width: 222, height: 92 },
  lyricDim: { color: "#777a75", fontSize: 12, lineHeight: 16,
    textAlign: "center" },
  lyricCurrent: { color: "#d74f10", fontSize: 16, lineHeight: 20,
    fontWeight: "700", textAlign: "center" },
  seekPanel: { position: "absolute", left: 49, top: 65, width: 222, height: 105 },
  seekLabel: { width: 222, height: 10, color: "#969893", fontSize: 11,
    textAlign: "center" },
  ...
  seekInstruction: { width: 222, height: 10, color: "#969893", fontSize: 11,
